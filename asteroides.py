...
def create_asteroid1():
    return {
        'surface': pygame.image.load(
            os.path.join(RES_FOLDER, 'asteroid2.png')).convert_alpha(),
        'position': [randrange(892), -64],
        'speed': randrange(3, 9),
        'angle': 0,
        'angular_velocity': randrange(1, 10)
...
def create_asteroid2():
    return {
        'surface': pygame.image.load(
            os.path.join(RES_FOLDER, '1.png')).convert_alpha(),
        'position': [randrange(892), -64],
        'speed': randrange(3, 9),
        'angle': 0,
        'angular_velocity': randrange(1, 10)}

def create_asteroid3():
    return {
        'surface': pygame.image.load(
            os.path.join(RES_FOLDER, '2.png')).convert_alpha(),
        'position': [randrange(892), -64],
        'speed': randrange(3, 9),
        'angle': 0,
        'angular_velocity': randrange(1, 10)
...
def create_asteroid4():
    return {
        'surface': pygame.image.load(
            os.path.join(RES_FOLDER, '3.png')).convert_alpha(),
        'position': [randrange(892), -64],
        'speed': randrange(3, 9),
        'angle': 0,
        'angular_velocity': randrange(1, 10)
    }
def create_asteroid5():
    return {
        'surface': pygame.image.load(
            os.path.join(RES_FOLDER, '4.png')).convert_alpha(),
        'position': [randrange(892), -64],
        'speed': randrange(3, 9),
        'angle': 0,
        'angular_velocity': randrange(1, 10)
...
def main(is_two_player):
    ...
    while True:
        ...
        if not ticks_to_asteroid:
            ...
            asteroids.append(create_asteroid1())
            asteroids.append(create_asteroid2())
            asteroids.append(create_asteroid3())
            asteroids.append(create_asteroid4())
            asteroids.append(create_asteroid5())
